...
const Register = ({ setToken, setView }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('Welcome to FoodShare');
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="auth-form" noValidate>
            <div className="input-block">
              <input
                ...
                className={`modern-input ${errors.username ? 'has-error' : ''}`}
                placeholder=" "
                autoComplete="username"
                disabled={isLoading}
              />
              <label htmlFor="username" className="modern-label">Username</label>
            ...
            <div className="location-block">
              ...
              >
                <span className="btn-text">
                  {locationLoading ? 'Locating...' : 'Add Location'}
                </span>
              ...
              {(formData.latitude && formData.longitude) && (
                <div className="location-saved">
                  ...
                  <span className="saved-text">Location saved</span>
                </div>
              )}
            </div>
